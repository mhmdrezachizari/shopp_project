...
from .views import user_approval_list, approve_user, product_approval_list, approve_product , LoginView , delete_product,delete_user
app_name = 'susercustom'
urlpatterns = [
    # مسیرهای تأیید کاربران
